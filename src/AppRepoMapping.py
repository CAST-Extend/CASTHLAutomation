...
def setup_logger(log_file):
    try:
        ...
        print(f"Error while executing setup_logger() function: {e}")
...
def create_summary_logger(summary_log_file):
    try:
        ...
        print(f"Error while executing create_summary_logger() function: {e}")
...
def clean_folder_name(name):
    try:
        ...
        print(f"Error while executing clean_folder_name() function: {e}")
...
def move_and_delete_folders(root_dir, logger):
    try:
        ...
        print(f"Error while executing move_and_delete_folders() function: {e}")
